...
-   **지도에서 바로 찾는 2km 내 할인 쿠폰**  
    지도 위에서 현재 위치 기준*반경 2km 이내의 상점들과 해당 상점들이 제공하는 사용 가능한 할인 쿠폰을 즉시 확인할 수 있습니다. 현명하고 합리적인 소비를 위한 최고의 가이드가 되어줍니다.
...
- 드래그 앤 드롭으로 간단하게 메뉴 순서를 변경하여 추천 메뉴를 상단에 노출시킬 수 있습니다.
...
- 메뉴별 감성 분석 결과를 차트로 확인하여 어떤 메뉴의 만족도가 높은지 직관적으로 파악할 수 있습니다.
...
- 일별, 주별, 월별 매출 현황을 그래프로 확인하여 비즈니스 성과를 추적합니다.
...
#### 1. 위치 기반 맛집 탐색
- 앱 실행 시 현재 위치를 기반으로 주변 가게들을 지도에 표시합니다.
- 지도의 핀을 클릭하면 가게의 평점, 리뷰 개수, 대표 메뉴를 바로 확인할 수 있습니다.
...
- 주문 완료 후 실시간으로 주문 상태를 확인할 수 있어 안심하고 기다릴 수 있습니다.
...
- 리뷰 작성 시 포인트가 적립되어 다음 주문 시 할인 혜택을 받을 수 있습니다.
